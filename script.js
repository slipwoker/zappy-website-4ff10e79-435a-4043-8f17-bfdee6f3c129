document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        function showError(input, message) {
            ...
            errorElement.setAttribute('dir', 'auto');
        ...
        function validateField(input) {
            ...
            if (input.hasAttribute('required') && value === '') {
                const fieldName = input.getAttribute('data-label') || input.placeholder || input.name;
                showError(input, (document.dir === 'rtl' ? 'هذا الحقل مطلوب' : 'This field is required'));
                return false;
            }
            
            if (input.type === 'email' && value !== '' && !validateEmail(value)) {
                showError(input, (document.dir === 'rtl' ? 'يرجى إدخال بريد إلكتروني صالح' : 'Please enter a valid email address'));
                return false;
            }
            
            if (input.hasAttribute('minlength') && value.length < parseInt(input.getAttribute('minlength'))) {
                const minLength = input.getAttribute('minlength');
                showError(input, (document.dir === 'rtl' ? `يجب أن يكون ${minLength} أحرف على الأقل` : `Must be at least ${minLength} characters`));
                return false;
            }
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                if (submitButton) {
                    ...
                    submitButton.textContent = document.dir === 'rtl' ? 'جاري الإرسال...' : 'Sending...';
                    
                    setTimeout(function() {
                        submitButton.textContent = document.dir === 'rtl' ? 'تم الإرسال!' : 'Sent!';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '4ff10e79-435a-4043-8f17-bfdee6f3c129',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4ff10e79-435a-4043-8f17-bfdee6f3c129';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4ff10e79-435a-4043-8f17-bfdee6f3c129';
